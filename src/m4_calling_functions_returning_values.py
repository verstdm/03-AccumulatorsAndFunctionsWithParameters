...
def run_test_sum_of_digits():
    ...
    expected = 22
    answer = sum_of_digits(345343)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 14
    answer = sum_of_digits(2222222)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 30
    answer = sum_of_digits(191919)
...
def run_test_digits_in_power():
    ...
    expected = 31
    answer = digits_in_power(826, 2)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    expected = 27
    answer = digits_in_power(42, 4)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 26
    answer = digits_in_power(86, 3)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
